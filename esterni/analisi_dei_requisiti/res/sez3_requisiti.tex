...
\begin{longtable}[h!] { c c m{8.5cm} c}
	...
	RMP1 & Obbligatorio & Il tempo di aggiornamento della mappatura rispetto alla posizione delle unità nell'ambiente deve essere <= 5 secondi & Interno VE01 \\
	
	RDP1.1 & Desiderabile & Il tempo di aggiornamento della mappatura rispetto alla posizione delle unità nell'ambiente deve essere <= 2.5 secondi & Interno VE01 \\
	
	ROP1.2 & Opzionale & Il tempo di aggiornamento della mappatura rispetto alla posizione delle unità nell'ambiente deve essere <= 1 secondi & Interno VE01 \\
...
\begin{longtable}[h!] { >{\centering}m{5cm} >{\centering}m{5cm} }
	...
	\tabularnewline
	RMF6.9 & VE02.4\\UC6.01.10
	\tabularnewline
	RMF6.10 & VE02.4\\UC6.01.11
	\tabularnewline
