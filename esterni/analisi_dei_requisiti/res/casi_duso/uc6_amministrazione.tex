...
\subsubsection{UC6.3.2 - Modifica lista unità}
	\begin{figure}[H]
		\centering
		\includegraphics[width=16cm]{images/UC6.3.2.png}
...
\subsubsection{UC6.3.3 - Inserimento unità}
	\begin{itemize}
		...
		\item \textbf{Inclusione:} 
		\begin{itemize}
			\item \textbf{UC6.3.6:} viene eseguito l'input dei dati dell'unità.
		\end{itemize}
	\end{itemize}
...
\subsubsection{UC6.3.5 - Rimozione unità}
	\begin{itemize}
		\item \textbf{Attori primari:} utente amministratore;
...
\subsubsection{UC6.3.6 - Input dati unità}
	\begin{figure}[H]
		\centering
		\includegraphics[width=16cm]{images/UC6.3.6.png}
		\caption{Diagramma UC6.3.6 - Input dati unità}
	\end{figure}
	\begin{itemize}
		\item \textbf{Attori primari:} utente amministratore;
		\item \textbf{Descrizione:} l'amministratore inserisce i dati dell'unità interessata;
		\item \textbf{Scenario principale:} 
			\begin{itemize}
				\item l'amministratore esegue l'input dell'ID dell'unità (UC6.3.7).
			\end{itemize}
		\item \textbf{Precondizione:} l'amministratore sta inserendo i dati dell'unità interessata;
		\item \textbf{Postcondizione:} i dati dell'unità risultano inseriti nel sistema.
	\end{itemize}

\subsubsection{UC6.3.7 - Input ID unità}
	\begin{itemize}
		\item \textbf{Attori primari:} utente amministratore;
		...
		\item \textbf{Precondizione:} l'amministratore sta compilando i dati dell'unità interessata;
		\item \textbf{Postcondizione:} l'ID dell'unità risulta inserito.
		\item \textbf{Estensione:}
		\begin{itemize}
			\item \textbf{UC6.3.8:} se si tenta di usare l'ID di un'unità già esistente, viene visualizzato un apposito messaggio di errore.
		\end{itemize}
	\end{itemize}

\subsubsection{UC6.3.8 - Visualizzazione errore causa ID unità già esistente}
	\begin{itemize}
		\item \textbf{Attori primari:} utente amministratore;
