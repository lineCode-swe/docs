...
\subsubsection{UC6.2.3 - Visualizzazione errore causa formattazione mappa mal formattata}
	\begin{itemize}
		...
		\item \textbf{Scenario principale:} l'amministratore tenta di formattare erratamente la mappa;
...
\subsubsection{UC6.3.7 - Visualizzazione errore causa ID unità già esistente}
	\begin{itemize}
		\item \textbf{Attori primari:} utente amministratore;
