Per poter assicurare una conduzione e uno sviluppo del progetto che soddisfino le scadenze,il gruppo ha deciso di ripartire il lasso di tempo che va dalla sua formazione fino alla revisione di accettazione nelle seguenti cinque attività:
	...
	\begin{itemize}
		\item \dext{analisi dei requisiti};
	...
	\item \textbf{\dext{studio di fattibilità}}: impostato sulla base dell'analisi dei \glock{capitolati} fatta in precedenza;
	...
	\item \textbf{\dext{studio di fattibilità}}: fine dello \dext{studio di fattibilità}, basato sul \glock{capitolato} scelto.
	\end{itemize}
	...
	\begin{itemize}
		...
		\item \textbf{\dext{norme di progetto}}: stesura delle norme di progetto;
		\item \textbf{\dext{piano di progetto}}: stesura del piano di progetto;
		\item \textbf{\dext{analisi dei rischi}}: individuazione dei rischi che possono presentarsi nello svolgimento del progetto.
	\end{itemize}
	
	\paragraph{Quarto periodo dal 30-12-2021 al 07-01-2021}
	\begin{itemize}
	\item \textbf{\dext{Analisi dei requisiti}}: analisi dei requisiti e tracciamento;
	\item \textbf{\dext{piano di qualifica}}: stesura del \dext{piano di qualifica};
	\item \textbf{\dext{glossario}}: stesura del \dext{glossario}.
	\end{itemize}
	...
	\item \textbf{\dext{Analisi dei requisiti}}: revisione ed eventuale aggiornamento dei requisiti.
	...
	\item \textbf{\dext{analisi dei requisiti}}: revisione ed eventuale aggiornamento dei casi d’uso e dei requisiti, in base alle indicazioni ricevute;
