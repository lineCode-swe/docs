...
L'incremento di validazione e collaudo è l'ultimo incremento che prevede la conclusione del progetto.
Anche in questo caso il gruppo verrà suddiviso nei tre sottogruppi precedente descritti.

\begin{table} [h!]
	\begin{center}
		\rowcolors{2}{gray!25}{gray!6}
		\begin{tabular} { m{4cm}  m{11cm}  }	
			\multicolumn{2}{c}{	\textbf{Validazione e collaudo: dal 09-08-2021 al 15-08-2021}} \\
			\rowcolor{lightgray}
			\textbf{Assegnatari} & \textbf{Funzionalità} \\
			Gruppo UI & Validazione UI \\	
			Gruppo Server & Validazione server \\	
			Gruppo Unità &  Validazione unità
			Tutto il gruppo &  \begin{itemize}
				\item Validazione dell'intero sistema;
				\item Verifica e correzioni finali dei documenti in consegna;
