...
\begin{document}
	...
	Il consiglio del relatore è stato quello di incapsulare la parte di anagrafica in modo tale che il passaggio dei dati sia minimale.
	L'ultima parte dell'incontro è stata relativa alla configurazione dell'app config.
