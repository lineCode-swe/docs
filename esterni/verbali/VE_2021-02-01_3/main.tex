...
\setModifiche{
	...
	0.0.1 & Alessandro Dindinelli & Redattore & 01-02-2021 & Stesura iniziale}
...
\begin{table} [h!]
	...
	\begin{center}
		\begin{tabular} { m{2cm} m{14cm} }
			...
			VE\_2021-02-01\_3.1 & Verrà cancellato il requisito riguardante il versionamento tramite \glock{Github}.\\
			VE\_2021-02-01\_3.2 & Verranno ricontrollate e modificate opportunamente le pre e post condizioni dei casi d'uso.\\
			VE\_2021-02-01\_3.3 & Verrà tolto lo scenario in cui l'amministratore ha la possibilità di modificare le unità.
		\end{tabular}
	\end{center}
\end{table}
\end{document}
