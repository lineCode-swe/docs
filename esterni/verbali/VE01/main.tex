...
\begin{document}
	...
	\end{itemize}
		...
		Il proponente ha reso noto al gruppo che la licenza \glock{open-source} da utilizzare per il prodotto dovrà essere la più stringente possibile, dipendentemente dalle licenze che vengono applicate alle componenti software che saranno utilizzate per la realizzazione del prodotto finale.
		...
		\begin{table} [h!]
			...
			\begin{center}
				\begin{tabular} { m{2cm} m{14cm} }
					...
					VE01.3 & Le unità a guida totalmente unità vengono guidate unicamente dal sistema per quanto concerne il percorso da seguire \\
					VE01.4 & La Licenza da dare al prodotto dovrà essere open-source, in accordo alla licenza più stringente delle componenti software che vengono utilizzate. 
				\end{tabular}
			\end{center}
		\end{table}			
