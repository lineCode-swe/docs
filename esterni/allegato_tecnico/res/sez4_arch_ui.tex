...
La comunicazione con il server avviene tramite \glock{WebSocket} e dunque asincrona. Viene sfruttato il design pattern \textit{Observer} per permettere un'aggiornamento asincrono dei componenti dell'interfaccia.\\
