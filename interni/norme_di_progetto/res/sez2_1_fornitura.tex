\subsection{Fornitura}
	...
	\subsubsection{Attività}
		...
		\paragraph{Documentazione esterna}
    		...
    		\begin{itemize}
    		 	\item \dext{Piano di progetto v3.0.0}: documento che descrive le metodologie di pianificazione, consegna e completamento del progetto;
    		 	\item \dext{Piano di qualifica v3.0.0}: documento che contiene le attività di verifica, validazione e garantisce la qualità dei processi e di prodotto;
    		 	\item \dext{Analisi dei requisiti v3.0.0}: documento contenente l'analisi dei requisiti e dei casi d'uso del gruppo;
    		 	\item \dext{Glossario v3.0.0}: documento con tutti i termini che potrebbero essere di difficile comprensione presenti nella documentazione.
    		\end{itemize}
