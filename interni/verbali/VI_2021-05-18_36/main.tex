...
\setModifiche{
	1.0.0 & Alessandro Chimetto & Responsabile & 20-05-2021 & Approvazione documento\\
	0.1.0 & Matteo Alba, Alessandro Dindinelli & Amministratore, Verificatore & 20-05-2021 & Stesura
}
...
\begin{table} [h!]
	...
	\begin{center}
		\begin{tabular} { m{2cm} m{14cm} }
			...
			VI\_2021-05-18\_36.1 & I tipi ad-hoc per i messaggi non sono necessari nelle componenti che usano \glock{Typescript} \\
		\end{tabular}
	\end{center}
\end{table}
