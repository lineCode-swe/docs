...
\setModifiche{ 
		...
		0.1.0 & Alessandro Dindinelli & Verificatore & 9-01-2021 & Verifica documento\\
		0.0.0 & Paolo Scanferlato & Amministratore & 9-01-2021 & Prima stesura}
...
\begin{document}
	...
	%--------------------------------
		...
		\begin{itemize}
			...
			\item \textbf{Data}: 9 Gennaio 2021;
