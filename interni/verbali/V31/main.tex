...
\begin{document}
	...
	\section{Svolgimento}
		...
		Ci si è sincronizzati sullo stato dei lavori riguardo il cambio tecnologico tra \glock{API Rest} ed \glock{Atmosphere}, per il miglioramento del sistema di comunicazione tra le componenti del sistema. \\
