...
\setModifiche{
	...
	0.0.0 & Alessandro Dindinelli & Redattore & 17-12-2020 & Stesura iniziale}
...
\begin{document}
	...
	\section{Svolgimento}
		...
		Si è deciso di provare a procedere andando a fissare una prossima riunione in cui il gruppo discuterà del contenuto delle \dext{Norme di Progetto v1.0.0}, spartendosi poi la redazione del documento in parti tra i membri del gruppo.\\
