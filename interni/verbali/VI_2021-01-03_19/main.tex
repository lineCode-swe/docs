...
\setModifiche{
	...
	0.0.1 & Alessandro Dindinelli & Redattore & 03-01-2021 & Stesura iniziale}
...
\begin{document}
	...
	\section{Introduzione}
		...
		\begin{enumerate}
            \item discussione sullo stato dei lavori per la redazione del documento \dext{Analisi dei Requisiti v1.0.0};
	...
	\section{Svolgimento}
        ...
        Si è deciso di iniziare uno sviluppo parallelo per il documento \dext{Piano di Qualifica v1.0.0} che verrà portato avanti inizialmente dai membri del gruppo che non hanno attualmente compiti legati al redigere il documento \dext{Analisi dei Requisiti v1.0.0}. \\
