...
\setModifiche{ 
		...
		0.1.0 & Giacomo Bulbarelli & Verificatore & 10-01-2021 & Verifica prima stesura \\
		0.1.0 & Alessandro Dindinelli & Redattore & 10-01-2021 & Prima stesura}
...
\begin{document}
	...
	%--------------------------------
		...
		\begin{enumerate}
			...
			\item Consegna documenti per RR;
	...
	\section{Svolgimento}
		...
		\subsection{Consegna documenti per RR}
		Sono stati preparati i documenti da presentare per la Revisione dei Requisiti (RR), e si è proceduto all'invio delle mail necessarie ai professori.\\
