...
\setModifiche{
	0.1.0 & Valton Tahiraj & Verificatore & 13-06-2021 & Verifica documento \\
	0.0.0 & Paolo Scanferlato & Amministratore & 12-06-2021 & Prima stesura}
...
\begin{table} [h!]
	...
	\begin{center}
		\begin{tabular} { m{2cm} m{14cm} }
			...
			V40.1 & Decisa la struttura del manuale utente \glock{Typescript} \\
		\end{tabular}
	\end{center}
\end{table}
