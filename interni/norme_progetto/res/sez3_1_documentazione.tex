\subsection{Documentazione}
	...
	\begin{itemize}
		...
		\item un file per ogni sezione pronto per essere importato nella posizione prevista del file principale.
	\end{itemize}
	...
	\begin{enumerate}
		...
		\item \textbf{Decisioni prese}: una tabella che riassume le decisioni prese dal gruppo assegnando ad ognuna di esse un identificativo univoco aggiungendo al nome del verbale un "." e un numero progressivo a partire da 1.
	\end{enumerate}
	...
	Per la stesura di tutti i documenti verrà utilizzato il formato \LaTeX\ v2e (\url{https://www.latex-project.org/})\\
	Il software di editing sarà TeXstudio v3.0.1 (\url{https://texstudio.org/}), software \glock{open-source} compatibile con tutti i sistemi operativi utilizzati dal gruppo.\\Sarà, inoltre, obbligatorio attivare il correttore ortografico in italiano del software per ridurre al minimo gli eventuali errori di digitazione.