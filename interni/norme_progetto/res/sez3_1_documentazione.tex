\subsection{Documentazione}
	...
	\begin{enumerate}
		...
		\item \textbf{sviluppo}: i Redattori del documento, utilizzando il software \glock{TeXstudio}, aggiungono i contenuti assegnati in maniera incrementale aggiornando anche il numero di versione;
