\subsection{Documentazione}
	...
	\begin{itemize}
		\item Casi d'uso in formato \glock{UML}
		\item Schema relativo al design della base di dati utilizzata (nell'eventualità in cui essa si riveli necessaria)
		\item Documentazione relativa alle \glock{API} realizzate
		\item Elenco dei bug risolti durante lo sviluppo del software
	\end{itemize}
	...
	\subsubsection{Attività}
		...
		\begin{itemize}
			...
			\item \textbf{termini nel Glossario}: tutti i termini presenti nel \dext{Glossario v1.0.0} sono scritti in \textsc{maiuscoletto} e hanno a pedice una G maiuscola \glock{};
