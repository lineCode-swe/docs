\subsection{Fornitura}
	...
	\subsubsection{Attività}
		...
		\begin{itemize}
		 	\item \dext{Piano di progetto}: documento che descrive le metodologie di pianificazione, consegna e completamento del progetto;
		 	\item \dext{Piano di qualifica}: documento che contiene le attività di verifica, validazione e garantisce la qualità dei processi e di prodotto;
		 	\item \dext{Analisi dei requisiti}: documento contenente l'analisi dei requisiti e dei casi d'uso del gruppo;
