\subsection{Gestione Processi}
	...
	\end{itemize}
	Queste attività sono riportate in modo dettagliato nel \dext{Piano di Progetto}, elaborato dal responsabile di progetto in collaborazione con l'amministratore.
	...
	Tutti i membri del gruppo dovranno assumere diversi ruoli a rotazione e, per ognuno di essi, saranno previsti compiti specializzati. Di seguito sono riportate, in linea generale, gli aspetti caratterizzanti di ogni ruolo che verrà ricoperto.
		...
		\begin{itemize}
			...
			\item redigere le \dext{Norme di Progetto} e parte del \dext{Piano di Qualifica}.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item redigere parte del \dext{Piano di Qualifica}, la Specifica Tecnica e la Definizione del Prodotto.
		\end{itemize}
