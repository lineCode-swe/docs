\subsection{Gestione Processi}
	...
	\end{itemize}
	Queste attività sono riportate in modo dettagliato nello \dext{Studio di Fattibilità}, elaborato dal responsabile di progetto in collaborazione con l'amministratore.
	...
	Le attività previste secondo il \dext{Piano di Progetto} sono:
	\begin{itemize}
	...
	Tutti i membri del gruppo dovranno assumere diversi ruoli a rotazione e, per ognuno di essi, saranno previsti compiti specializzati descritti all'interno del \dext{Piano di Progetto}. Di seguito sono riportate, in linea generale, gli aspetti caratterizzanti di ogni ruolo che verrà ricoperto.
		...
		\begin{itemize}
			...
			\item gestire i rischi in base al \dext{Piano di Progetto};
			\item redigere il \dext{Piano di Progetto}.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item redigere le \dext{Norme di Progetto}.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item redigere l'\dext{Analisi dei Requisiti} e lo \dext{Studio di Fattibilità}.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item redigere il \dext{Piano di Qualifica}, la Specifica Tecnica e la Definizione del Prodotto.	
		\end{itemize}
		...
		\begin{itemize}
			\item controllare i lavori in fase di revisione seguendo le \dext{Norme di Progetto};
		...
		\end{itemize}
		 ...
		 Le \glock{Issue} create vengono automatizzate tramite il Project, \glock{template Automated Kanban}, che permette una visualizzazione più pratica sul tracciamento delle attività. \\
		 ...
		 I rischi che verranno rilevati e conseguentemente classificati, sono descritti dettagliatamente nel \dext{Piano di Progetto} che sarà sempre aggiornato su:
		 \begin{itemize}
	...
	Dove:
	 ...
	 \paragraph{MP06 - Unbudgeted Risks - UR}
 	...
 	\end{itemize}
		 ...
		 \begin{itemize}
		 	...
		 	\item {\bfseries \glock{GitHub}}: strumento per il versionamento remoto dei file condivisibili a tutti i membri del gruppo;
