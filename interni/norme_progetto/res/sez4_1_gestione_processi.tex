\subsection{Gestione processi}
	...
	\end{itemize}
	Queste attività sono riportate in modo dettagliato nel \dext{Piano di Progetto v1.0.0}, elaborato dal responsabile di progetto in collaborazione con l'amministratore.
	...
	Le attività previste secondo il \dext{Piano di Progetto v1.0.0} sono:
	\begin{itemize}
	...
	\end{itemize}
		...
		I rischi che verranno rilevati e conseguentemente classificati, sono descritti dettagliatamente nel \dext{Piano di Progetto v1.0.0} che sarà sempre aggiornato su:
		\begin{itemize}
	...
	Tutti i membri del gruppo dovranno assumere diversi ruoli a rotazione e, per ognuno di essi, saranno previsti compiti specializzati. Di seguito sono riportate, in linea generale, gli aspetti caratterizzanti di ogni ruolo che verrà ricoperto.
		...
		\begin{itemize}
			...
			\item gestire i rischi in base al \dext{Piano di Progetto v1.0.0};
			\item redigere il \dext{Piano di Progetto v1.0.0}.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item redigere le \dext{Norme di Progetto v1.0.0} e parte del \dext{Piano di Qualifica v1.0.0}.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item redigere l'\dext{Analisi dei Requisiti v1.0.0} e lo \dext{Studio di Fattibilità v1.0.0}.
		\end{itemize}
		...
		\begin{itemize}
			...
			\item redigere parte del \dext{Piano di Qualifica v1.0.0}, la Specifica Tecnica e la Definizione del Prodotto.
		\end{itemize}
		...
		\begin{itemize}
			\item controllare i lavori in fase di revisione seguendo le \dext{Norme di Progetto v1.0.0};
