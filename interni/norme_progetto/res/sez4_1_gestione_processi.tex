\subsection{Gestione Processi}
	...
	Tutti i membri del gruppo dovranno assumere diversi ruoli a rotazione e, per ognuno di essi, saranno previsti compiti specializzati descritti all'interno del Piano di Progetto. Di seguito sono riportate, in linea generale, gli aspetti caratterizzanti di ogni ruolo che verrà ricoperto.
		...
		\begin{itemize}
			...
			\item definire e sviluppare l'architettura che verrà sviluppata, favorendo mantenibilità e stabilità;
		...
		\end{itemize}
		 ...
		 Il  \glock{workspace} è suddiviso nel seguente modo:
		 	...
		 	\item {\ttfamily pull-request}: contenitore dei \glock{commit} e dei suoi verificatori.
		 	\end{itemize}
		 ...
		 Dopodichè si trattano gli argomenti del giorno che sono stati tracciati alla riunione precedente o durante comunicazioni interne. 
		 ...
		 I rischi che verranno rilevati e  e che saranno classificati, sono descritti dettagliatamente nel Piano di Progetto che sarà sempre aggiornato su:
		 \begin{itemize}
		 	\item nuovi rischi individuati;
		 	\item ridefinizione, all'occorenza, di nuove strategie sulla gestione dei rischi;
