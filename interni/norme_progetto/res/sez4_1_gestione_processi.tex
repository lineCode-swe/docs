...
dove Lettera può assumere i seguenti valori:
	...
	Durante la realizzazione del processo verranno utilizzate le seguenti metriche di qualità sulla gestione ed il tracciamento di processi e rischi; al fine di ottenere efficacia ed efficienza.
 	...
 	\begin{itemize}
 		...
 		\item \textbf{\glock{GitKraken}}: strumento collegato alla \glock{Repository} \glock{GitHub}, per gestire in modo più semplice ed intuitivo i branch, commit e pull request. Viene inoltre utilizzato per l'implementazione e la gestione del sistema di \glock{board} descritto alla sezione 4.1.3;
